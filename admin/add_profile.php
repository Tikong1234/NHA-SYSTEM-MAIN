...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM profiling WHERE block_number = '$block_number' AND lot_number = '$lot_number' ";
            ...
            // If the combination exists, display an error message
               echo '<script>
                    window.onload = function() {
                        Swal.fire({
                            title: "Error!",
                            text: "Block Number and Lot Number already occupied!",
                            icon: "error"
                        });
                    };
                  </script>';
        }   else {
            // Check if the client with the same name and email already exists
            $sql = "SELECT * FROM profiling WHERE lastname = '$lastname' AND firstname = '$firstname' AND middlename = '$middlename'";
            $result = mysqli_query($bd, $sql);
            if (mysqli_num_rows($result) > 0) {
                // If the client exists, display an error message
                echo '<script>
                    window.onload = function() {
                        Swal.fire({
                            title: "Error!",
                            text: "The credentials you enter already exist with different block number and lot number",
                            icon: "error"
                        });
                    };
                  </script>';
                ...
                $sql = "INSERT INTO `profiling`(`block_number`, `lot_number`,`lastname`, `firstname`, `middlename`, `gender`, `barangay`,`remarks`) VALUES ('$block_number','$lot_number','$lastname','$firstname','$middlename','$gender','$barangay','$remarks ')";
              ...
              <div class="col-md-6">
               <div class="form-group">
                <label for="" class="control-label">Last Name</label>
                 <input type="text" class="form-control" autocomplete="off" name="lastname" class="span8 tip" autocomplete="off" placeholder="Last Name"required>
            </div>
          </div>
          ...
          <div class="col-md-6">
                    <div class="form-group">
                     <label for="" class="control-label">First Name</label>
                       <input type="text" class="form-control" autocomplete="off" name="firstname" placeholder="Firstname" class="span8 tip" required>
                 </div>
          </div>
             </div>
              ...
              <div class="col-md-6">
               <div class="form-group">
                <label for="" class="control-label">Middle Name</label>
                 <input type="text" class="form-control" autocomplete="off" name="middlename" class="span8 tip" autocomplete="off" placeholder="Middle Name" required>
            </div>
          </div>
              ...
              <div class="col-md-6">
               <div class="form-group">
                <label for="" class="control-label">Barangay</label>
                 <input type="text" class="form-control" autocomplete="off" name="barangay" class="span8 tip" autocomplete="off" placeholder="Barangay" required>
            </div>
          </div>
          ...
          <div class="col-md-6">
                    <div class="form-group">
                     <label for="" class="control-label">Remarks</label>
                       <input type="text" class="form-control" autocomplete="off" name="remarks" placeholder="Remarks" class="span8 tip" required>
                 </div>
          </div>
             </div>
